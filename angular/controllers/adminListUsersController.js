...
myApp.controller('adminListUsersController', ['$scope', '$http', function ($scope, $http) {
        
	var RegisterData = "{\"operation\" : \"LISTUSERS\" , \"schoolusername\" : \"" + $scope.schoolid + "\" }";
	...
	$http({
		...
		.then(
			...
			$scope.removeuser = function (schoolid, username, fullname) {
				...
				var c = window.confirm("Are you sure that you would like to delete the user " + fullname + "?");
